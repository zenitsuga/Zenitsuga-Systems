...
-- Dumping data for table 0hsoozjazg.tbl_condo_billingdetails: ~0 rows (approximately)
DELETE FROM `tbl_condo_billingdetails`;
/*!40000 ALTER TABLE `tbl_condo_billingdetails` DISABLE KEYS */;
INSERT INTO `tbl_condo_billingdetails` (`sysID`, `PrimaryKey`, `BillingRefID`, `BillingDescription`, `BillingAmount`, `BillingNotes`, `PaymentRefID`, `PaymentAmount`, `Balances`, `PaymentNotes`, `isEnabled`) VALUES
	(1, '000000000001_6', 6, 'MONTHLY DUES For Month : April 2019', 2400.00, '', -1, 0.00, 0.00, NULL, 1);
...
-- Dumping data for table 0hsoozjazg.tbl_condo_billinginfo: ~0 rows (approximately)
DELETE FROM `tbl_condo_billinginfo`;
/*!40000 ALTER TABLE `tbl_condo_billinginfo` DISABLE KEYS */;
INSERT INTO `tbl_condo_billinginfo` (`sysID`, `PrimaryKey`, `CutoffID`, `CustomerID`, `TotalAmountDue`, `PreviousBalanceAsOf`, `LastPaymentEntry`, `Balances`, `CurrentCharges`, `isEnabled`, `isVoid`, `CreatedBy`, `CreatedDate`, `UpdateBy`, `UpdatedDate`, `VoidedBy`, `VoidedDate`, `VoidReason`) VALUES
	(6, '000000000001', 1, 1, 2550.00, 0.00, 0.00, 0.00, 2550.00, 1, 0, 0, '2019-04-05 10:48:35', 0, '2019-04-05 10:48:35', 0, '2019-04-05 10:48:35', NULL);
